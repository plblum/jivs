...
- **Breaking API changes** - Several renames of types.
  + LoggerService -> LoggingService
  + TextLocalizerService -> ErrorMessagesService
  + AutoGenerateDataTypeCheckService -> DataTypeCheckGeneratorService
- Expanded the power and importance of auto-generated Data Type Check Validators through the DataTypeCheckService
- **Documentation improvements** - All of the Jivs API docs have been overhauled. There is a new Learning Jivs section. There are new home pages for documentation. TypeDoc has been structured to omit the stuff now in our Docs library. [https://github.com/plblum/jivs/blob/main/docs/Home.md](https://github.com/plblum/jivs/blob/main/docs/Home.md).
