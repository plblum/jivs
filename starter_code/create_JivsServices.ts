 ...
 * - `AutoGenerateDataTypeCheckService`: Register your own `DataTypeCheckGenerators`.
...
*/
     ...
     * @param ag 
     */
    function registerDataTypeCheckGenerators(ag: AutoGenerateDataTypeCheckService): void
    {
        ag.lazyLoad = (service) =>
        {
