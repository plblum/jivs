 ...
 * - `TextLocalizerService` - Supports localized strings for error messages, labels, and more. 
...
*/
    ...
    function createTextLocalizerService(usage: 'client' | 'server' | 'all' = 'client'): ITextLocalizerService
    {
