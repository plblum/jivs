...
import { DataTypeCheckGeneratorService } from '../Services/DataTypeCheckGeneratorService';
...
import { TestingLoggingService } from './TestingLoggingService';
 ...
 * - By default, it uses the TestingLoggingService with LoggingLevel.Error.
...
export function createJivsServicesForTesting(options?: TestingJivsServicesOptions): TestingJivsServices {
    ...
    const consoleLogger = new ConsoleLoggingService(options.loggerLevel ?? LoggingLevel.Error);
    const testingLogger = new TestingLoggingService(options.loggerLevel ?? LoggingLevel.Error, consoleLogger);
    vs.loggingService = testingLogger;
    ...
    const ag = new DataTypeCheckGeneratorService();
...
export class TestingJivsServices extends JivsServices
{
    ...
    override get loggingService(): TestingLoggingService
    {
        return super.loggingService as TestingLoggingService;
    }
    override set loggingService(value: TestingLoggingService)
    {
        super.loggingService = value;
    }
}