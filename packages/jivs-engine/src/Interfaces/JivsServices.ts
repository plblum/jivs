...
import { IDataTypeCheckGeneratorService } from './DataTypeCheckGeneratorService';
...
export enum ServiceName {
    ...
    /**
     * IDataTypeCheckGeneratorService
     */    
