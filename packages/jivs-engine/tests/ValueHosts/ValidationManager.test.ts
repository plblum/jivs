...
function setupValidationManager(descriptors?: Array<InputValueHostDescriptor> | null,
    ...
    registerDataTypeComparers(services.dataTypeComparerService as DataTypeComparerService);
    registerDataTypeConverters(services.dataTypeConverterService as  DataTypeConverterService);
    registerDataTypeFormatters(services.dataTypeFormatterService as DataTypeFormatterService);
    registerDataTypeIdentifiers(services.dataTypeIdentifierService as DataTypeIdentifierService);
    registerDataTypeCheckGenerators(services.autoGenerateDataTypeCheckService as AutoGenerateDataTypeCheckService);
    services.autoGenerateDataTypeCheckService.enabled = false;
