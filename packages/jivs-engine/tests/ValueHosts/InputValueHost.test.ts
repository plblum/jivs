...
import { IValidatableValueHostBase, ValidatableValueHostBaseConfig, ValueHostValidationState } from "../../src/Interfaces/ValidatableValueHostBase";
...
import { createValidationServicesForTesting, registerDataTypeParsers } from "../TestSupport/createValidationServices";
...
describe('No mocks!', () => {
    function createServices(logLevel: LoggingLevel = LoggingLevel.Debug): ValidationServices {
        let services = createValidationServicesForTesting();
        services.loggerService.minLevel = logLevel;
        return services;
    }
    function createBuilder(callbacks: IValidationManagerCallbacks, services?: ValidationServices ): ValidationManagerConfigBuilder {
