import { DataTypeCheckCondition, RegExpCondition, RegExpConditionDescriptor } from "../../src/Conditions/ConcreteConditions";
...
describe('AutoGenerateDataTypeCheckService.AutoGenerateDataTypeCondition', ()=> {
    test('Not registered lookupKey returns DataTypeCheckCondition', () => {
        ...
        // really should test for the Descriptor.valueHostName to be 'Field1'
