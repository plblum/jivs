...
import { createMockValidationManagerForMessageTokenResolver } from "../Mocks";
...
describe('resolveTokens', () => {
    test('Invalid parameters', () => {
        ...
        let messageTokeSource = {
            getValuesForTokens: function (valueHost, vm) {
                return [];
            }
        };
    ...
    test('Message with {token:formatter} where formatter does not support value is not replaced and gets logged', () => {
        let vm = createMockValidationManagerForMessageTokenResolver(true);
        let logger = vm.services.loggerService;
        let messageTokeSource = {
            getValuesForTokens: function (valueHost, vm) {
                return [{
                        tokenLabel: 'token',
...
//# sourceMappingURL=MessageTokenResolverService.test.js.map