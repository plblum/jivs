...
describe('DataTypeCheckGeneratorService.RegisterDataTypeCheckGenerator', () => {
...
describe('DataTypeCheckGeneratorService.AutoGenerateDataTypeCondition', ()=> {
    test('Not registered lookupKey returns DataTypeCheckCondition', () => {
        ...
        let vh = vhm.addMockFieldValueHost('Field1', LookupKey.String, 'label');
        let testItem = services.dataTypeCheckGeneratorService;
    ...
    test('Registered with a class that returns a condition. Returns an instance of that condition for the same ValueHostName', () => {
        ...
        let vhm = new MockValueHostsManager(services);
        let vh = vhm.addMockFieldValueHost('Field1', LookupKey.String, 'label');
        let testItem = services.dataTypeCheckGeneratorService as DataTypeCheckGeneratorService;
    ...
    test('Registered class is configured to emulate PositiveInteger returning DataTypeCheck, Positive, and Integer conditions.', () => {
        let services = new MockJivsServices(true, true);  // already setup with DataTypeCheck, Positive and Integer
        let logger = services.loggingService as TestingLoggingService;
        logger.minLevel = LoggingLevel.Debug;
