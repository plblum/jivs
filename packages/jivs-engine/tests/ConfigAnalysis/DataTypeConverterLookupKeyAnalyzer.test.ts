...
import { CAIssueSeverity, ConverterServiceCAResult } from '../../src/Interfaces/ConfigAnalysisService';
...
describe('DataTypeConverterLookupKeyAnalyzer', () => {
    ...
    describe('analyze()', () => {
        test('Source is a string, requested result is number. Will identify TestStringToNumberConverter with no errors found ', () => {
            ...
            let result = analyzer.analyze(resultKey, valueHostConfig) as ConverterServiceCAResult;
