...
import {
    ...
    LocalizedPropertyCAResult, ParserFoundCAResult,
    ParserServiceCAResult, ParsersByCultureCAResult, CAFeature, PropertyCAResult,
    CAResultBase,
    IConfigAnalysisSearchCriteria,
    CAIssueSeverity, IssueForCAResultBase,
    ICASearcher, IConfigAnalysisOutputter,
...
} from "../../src/ConfigAnalysis/ConfigAnalysisResultsExplorer";
