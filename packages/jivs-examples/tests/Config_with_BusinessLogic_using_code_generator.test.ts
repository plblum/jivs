...
import {
    ...
    configExample
} from '../src/Config_with_BusinessLogic_using_code_generator';
...
describe('ReportingBusinessLogic', () => {
    it('should return correct fields metadata', () => {
        const logic = new ReportingBusinessLogic();
...
describe('BusinessLogicCodeGen', () => {
    it('should generate correct ValidationManagerConfig', () => {
        let reportingBusinessLogic = new ReportingBusinessLogic();
        let businessLogicCodeGen = new BusinessLogicCodeGen(reportingBusinessLogic,
            createValidationServices('en'));
        businessLogicCodeGen.generate();
        let config = businessLogicCodeGen.getValidationManagerConfig();
            ...
            validatorConfigs: [
                {
                    ...
                    conditionConfig: <RegExpConditionConfig>{
                        ...
                        valueHostName: 'timeZone'
                    }
                }
            ]
        };
        expect(config.valueHostConfigs).toEqual([expectedStartDate, expectedEndDate, expectedTimeZone]);
    });
