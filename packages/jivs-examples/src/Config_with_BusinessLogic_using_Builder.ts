...
/* General steps:
 ...
 5. Create the ValidationManager, passing in the builder object.
 6. Where you need to change the configuration, after this point, use the Modifier API.
...
export function configExample(): ValidationManager
{
    ...
    // Step 5: Create the ValidationManager, passing in the builder object.
    ...
    // Step 6: We want to show the current time zone in the start date label.
...
/* --- this code doesn't belong here, it is showing some changes to the above    
    // In Step 4, we could also have setup this code while working with the builder, above.
    ...
    // then our Step 6 would look like this:
