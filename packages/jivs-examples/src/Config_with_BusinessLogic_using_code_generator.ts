...
/* General steps:
 ...
 4. Use its startUILayerConfig() method to indicate that the upcoming configuration must be merged carefully
...
export function configExample(): ValidationManager
{
    ...
    // to FieldValueHosts. PropertyValueHosts are often generated by the business logic
...
export class BusinessLogicCodeGen {
    ...
    protected generateField(field: FieldMetadata): void {
        // we could use FieldValueHostConfig here too, as the UI needs it.
        ...
        // see builder.startUILayerConfig({ convertPropertyToInput: true }); above.
