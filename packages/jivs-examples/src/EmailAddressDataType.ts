...
declare module "@plblum/jivs-engine/build/ValueHosts/Fluent"
{
    ...
    export interface FluentConditionCollector {
        emailAddress(valueHostName?: ValueHostName): FluentConditionCollector;
    }
}
...
function emailAddressForCondition(valueHostName?: ValueHostName): FluentConditionCollector {
...
FluentValidatorCollector.prototype.emailAddress = emailAddressForValidator;
FluentConditionCollector.prototype.emailAddress = emailAddressForCondition;
