...
export class EmailAddressFluentValidatorBuilder
...
export function registerEmailAddress(validationServices: IValidationServices): void
{
    ...
    ff.setFluentValidatorBuilderCreator((parentConfig: FieldValueHostConfig) => {
        return new EmailAddressFluentValidatorBuilder(validationServices, parentConfig) as unknown as IFluentValidatorBuilder;
    });
