...
// It must still be registered in the JivsServices.autoGenerateDataTypeCheckService.
...
export function registerEmailAddress(services: IJivsServices): void
{
    ...
    let ag = services.autoGenerateDataTypeCheckService as AutoGenerateDataTypeCheckService;
