...
import { RegExpCondition } from "../../jivs-engine/build/Conditions/ConcreteConditions";
import { ConditionFactory } from "../../jivs-engine/build/Conditions/ConditionFactory";
import { AutoGenerateDataTypeCheckService } from "../../jivs-engine/build/Services/AutoGenerateDataTypeCheckService";
import { RegExpConditionDescriptor } from "../../jivs-engine/src/Conditions/ConcreteConditions";
import { ConditionCategory, IConditionFactory, ICondition } from "../../jivs-engine/src/Interfaces/Conditions";
import { IDataTypeCheckGenerator } from "../../jivs-engine/src/Interfaces/DataTypeCheckGenerator";
import { IInputValueHost } from "../../jivs-engine/src/Interfaces/InputValueHost";
...
{
    let df = validationServices.conditionFactory as ConditionFactory;
    // or move just this line into registerDataTypeCheckGenerators() function     
    df.register<RegExpConditionDescriptor>(EmailAddressConditionType, (descriptor) => new EmailAddressCondition(descriptor)); 
