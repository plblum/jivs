    ...
    public checkLocalization(propertyNamePrefix: string, l10nKey: string | null | undefined,
        ...
        if (l10nKey) {
            ...
            for (const cultureId of this.results.cultureIds) {
                ...
                const msg = `${propertyNamePrefix} localization not declared in ErrorMessagesService for culture "${cultureId}".`;
             
                const details = this.services.errorMessagesService.localizeWithDetails(cultureId, l10nKey, fallbackText ?? null);
